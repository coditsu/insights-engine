...
module InsightsEngine
  ...
  module Errors
    ...
    # Raised when we tried to execute a git command but for some reason it failed
    ...
    # Raised when we use case and we've got an unexpected type that we don't support
    class InvalidType < Base; end
    # Raised when we execute a command but something went wrong and the exception is
    # not yet supported
