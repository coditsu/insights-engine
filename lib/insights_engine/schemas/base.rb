...
module InsightsEngine
  module Schemas
    ...
    # so we won't get semivalid data out of this gem that's why the #call method is patched
    # @note With schemas we don't inherit directly. Instead we use following syntax:
